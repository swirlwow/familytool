...
const NAV_GROUPS = [
  ...
  },
  {
    title: "生活工具",
    items: [
      { name: "記事", href: "/notes", icon: NotebookPen },
  ...
  return (
    <div className="drawer lg:drawer-open family-shell">
      ...
      <div className="drawer-content flex min-h-screen flex-col">
        <div className="family-content flex-1 px-0 py-0 pb-24 sm:p-4 lg:pb-8 lg:p-7">
          {children}
        </div>
        <BottomNav />
      </div>
      ...
      <div className="drawer-side z-50">
        ...
        <aside className="family-sidebar min-h-full w-[220px] px-[18px] py-7 flex flex-col">
          <Link href="/" className="family-brand" aria-label="回到 FAMILYTOOL 首頁">
            ...
            <span>
              <strong>FAMILYTOOL</strong>
              <small>家庭生活工具</small>
            </span>
          </Link>

          <Link
            href="https://shift-leave-manager.vercel.app/"
            target="_blank"
            rel="noreferrer"
            className="shift-shortcut"
          >
