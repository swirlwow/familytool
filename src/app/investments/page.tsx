    ...
    <section className="app-panel overflow-hidden">
      <div className="flex flex-col gap-3 border-b border-slate-200 p-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="btn btn-sm rounded-lg border-0 bg-sky-600 text-white hover:bg-sky-700" onClick={() => setModal({ kind: "transaction", transactionType: "buy" })}><TrendingUp className="h-4 w-4" />新增買進</button>
          <button className="btn btn-sm rounded-lg border-amber-200 bg-amber-50 text-amber-700 hover:bg-amber-100" onClick={() => setModal({ kind: "transaction", transactionType: "sell" })}><TrendingDown className="h-4 w-4" />新增賣出</button>
          <button className="btn btn-sm rounded-lg border-emerald-200 bg-emerald-50 text-emerald-700 hover:bg-emerald-100" onClick={() => setModal({ kind: "transaction", transactionType: "dividend" })}><Coins className="h-4 w-4" />股利</button>
