...
export default function InvestmentsPage() {
  ...
  const tabs: [Tab, string][] = [["holdings", "持有部位"], ["transactions", "交易紀錄"], ["dividends", "股利紀錄"], ["corporate_actions", "股權異動"], ["settings", "基本資料"]];
